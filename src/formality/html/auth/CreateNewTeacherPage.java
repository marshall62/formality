 ...
 */
public class CreateNewTeacherPage {
    Map<String,String> districtMap;


    public CreateNewTeacherPage(Connection conn) throws Exception {
        districtMap = new DBAccessor().getAllDistricts(conn);
    }


    public void createPage(String msg, SystemInfo info, UserInfo teacherInfo,
