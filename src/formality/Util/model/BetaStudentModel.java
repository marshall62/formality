        ...
        while(fileiter.hasNext()){
          ...
          if(!curStudentID.equals(sID)){
              if(allStudentModels_.get(sID)==null){
                StudentSkillMatrix m = new StudentSkillMatrix();
               // module.init();
                  m.initMeanPriors();
          ...
          if(ans2!=null)
            curQuestionCt++;
          StudentSkillMatrix curModel = (StudentSkillMatrix)allStudentModels_.get(sID);
